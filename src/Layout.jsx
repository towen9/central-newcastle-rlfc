...
const adminPages = ['OwnerDashboard', 'AdminDashboard', 'AdminMembers', 'AdminOffers', 'AdminRewards', 'AdminNews', 'AdminQRCodes', 'AdminSponsors', 'AdminFixtures', 'AdminEvents', 'AdminGameDay', 'AdminTransactions', 'AdminLocationDiscounts', 'AdminUsers', 'AdminBulkImport', 'AdminFixturesComms', 'AdminMonitoring', 'AdminPerformance', 'AdminPushNotifications', 'AdminSMSNotifications', 'AdminReferrals', 'GateScan', 'BarScan', 'GateStaffGuide', 'CanteenStaffGuide', 'TroubleshootingGuide', 'GateStaffLogin', 'CanteenStaffLogin', 'LeaguesClubScan', 'MerchandiseScan', 'EventReport'];
